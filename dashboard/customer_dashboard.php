            ...
            <div class="d-flex align-items-center">
                <div class="text-end me-3">
                    <p class="mb-0 small fw-bold">
                        <a href="../auth/profile.php" class="text-dark text-decoration-none">
                            <?= htmlspecialchars($_SESSION['user_name']) ?> <i class="ri-settings-4-line"></i>
                        </a>
                    </p>
                    <p class="mb-0 text-muted small">Account Settings</p>
                </div>

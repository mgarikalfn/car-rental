...
<head>
    ...
    <style>
        ...
        .nav-tabs .nav-link { 
            color: #15191d; border: 1px solid #15191d; 
            border-radius: 5px; font-weight: 500; transition: 0.3s;
        }
        .nav-tabs .nav-link.active { 
            background-color: #f5b754 !important; color: #15191d !important; border-color: #f5b754; 
        }
        .car__img { width: 100%; height: 200px; object-fit: cover; border-radius: 8px; }
                    ...
                    <table class="table table-hover align-middle">
                        ...
                        <tbody>
                            <?php if($bookings_result->num_rows > 0): ?>
                                ...
                                <?php endwhile; ?>
                            <?php else: ?>
                                <tr><td colspan="5" class="text-center text-muted py-4">No bookings found yet.</td></tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                </div>
